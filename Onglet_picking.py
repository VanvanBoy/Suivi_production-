# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 14:30:38 2025
...
def create_picking_interface(tab,conn,cursor):
    ...
    def etape_picking():
        ...
        if etat==1:
            messagebox.showinfo("Succès!","Point de controle picking OK! Passage à l'etape suivante")
        else : 
            messagebox.showerror("Fail!","Point de controle picking NON OK!")
    ...
    ctrl_label = tk.Label(right_frame, text="Controle tension des cellules:", font=('Arial', 12))
    ...
    # Bouton Sauvegarder
    submit_button = tk.Button(right_frame, text="Process", command=etape_picking, font=('Arial', 12), bg='blue', fg='white')
