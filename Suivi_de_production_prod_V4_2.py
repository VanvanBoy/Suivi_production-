...
EXCEL_PATH = r"C:\Users\User\Desktop\test_DCIR_SP\Suivi_prod_par_modele.xlsx"
...
class StockApp(ThemedTk):
    ...
    def _show_model_selector_and_build(self):
        ...
        stage_to_func = {
            ...
            'choix_test': self.display_model_list_test,
        }
    ...
    def _create_widgets_with_order(self):
        ...
        stage_defs = {
            ...
            "choix_test": ("Choix profil de test", self.setup_choixtest),
    ...
    def valider_fl(self):
        ...
        try:
            ...
            if control_charge == "OK" and control_fonc == "OK" and tension_end  != "":
                query = "UPDATE suivi_production SET fin_ligne = 1, test_fonction= 1, test_charge= 1, test_tension_finale= %s, visa_fin_ligne= %s where numero_serie_batterie = %s "
    ...
    #__________________________Onglet choix test
        
     def setup_choixtest(self, frame):
         left_frame = ttk.Frame(frame)
         left_frame.pack(side="left", fill='both', expand=True, padx=20, pady=20)
